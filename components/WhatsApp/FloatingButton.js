...
export function FloatingButton({
    ...
    const handleSubmit = (event) => {
        ...
        if (onSubmit) {
            onSubmit(event, inputRef.current.value)
        } else {
    ...
    return (
        <div className={`${css.floatingWhatsapp} ${darkMode ? `${css.dark} ` : ''} ${className}`} style={style}>
            ...
            >
                ...
                <div className={css.chatBody} style={{ backgroundImage: `url(${darkMode ? '/assets/images/bg-chat-tile-light.png' : '/assets/images/bg-chat-tile-dark.png'})` }}>
                    {isDelay ? (
